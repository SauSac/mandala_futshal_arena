          ...
          <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-relaxed text-gray-400">
                Create tournaments, review
                generated brackets, record
                match winners, and manage
          ...
          <div className="rounded-3xl border border-gray-800 bg-gray-900 p-6 shadow-xl sm:p-8">
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm leading-relaxed text-gray-500">
                ...
                select players with active
                registrations and generate
